...
export default function DriverSettings() {
  ...
  const items = [
    { icon: User, label: t.settings.personalInfo, path: '/driver/settings/info' },
    { icon: CreditCard, label: t.settings.paymentInfo, path: '/driver/payout' },
    { icon: FileText, label: t.settings.termsAndConditions, path: '/driver/settings/terms' },
  ];
